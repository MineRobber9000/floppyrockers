-- The code in fr_conv.lua, as well as the code in aukit.lua, is licensed under the MIT license (fr_conv.lua by MineRobber___T, aukit.lua by JackMacWindows).
-- However, aukit.lua depends on 2 libraries from the ComputerCraft mod, which are licensed under the CCPL (ComputerCraft Public License).
-- These libraries are reproduced below.
...
return function() return expect, dfpwm end